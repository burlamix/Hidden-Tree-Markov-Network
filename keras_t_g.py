...
def training_use(htm,hidden_state,m,lerning_rate,epoche,batch_size,data_set,decay,stop_n,bs):
	...
	pi_l,sp_p_l,A_l,bi_l= np.load("ssave_3.npy")
	for i in range(m):
		free_th_l[i%3][0]=A_l[i%3]
		free_th_l[i%3][1]=sp_p_l[i%3]
		free_th_l[i%3][2]=pi_l[i%3]
		free_th_l[i%3][3]=bi_l[i%3]
